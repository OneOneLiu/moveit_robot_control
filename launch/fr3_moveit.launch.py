...
def generate_launch_description():
    ...
    kinematics_yaml = load_yaml(
        'moveit_robot_control', 'moveit_config/kinematics.yaml'
    )
    ...
    joint_limits_yaml = load_yaml(
        'moveit_robot_control', 'moveit_config/fr3_joint_limits.yaml'
    )
    ...
    ompl_planning_yaml = load_yaml(
        'moveit_robot_control', 'moveit_config/ompl_planning.yaml'
    )
    ompl_planning_pipeline_config['move_group'].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    moveit_simple_controllers_yaml = load_yaml(
        'moveit_robot_control', 'moveit_config/fr3_controllers.yaml'
    )
    moveit_controllers = {
